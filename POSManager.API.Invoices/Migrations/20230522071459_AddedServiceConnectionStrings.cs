...
namespace POSManager.API.Invoices.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseLevel = table.Column<int>(type: "int", nullable: false),
                    LicenseExpires = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ConnectionStringProducts = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConnectionStringInvoices = table.Column<string>(type: "nvarchar(max)", nullable: false),
